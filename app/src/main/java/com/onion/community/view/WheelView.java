...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs, com.pl.whellview.R.styleable.WheelView);
        unitHeight = (int) attribute.getDimension(com.pl.whellview.R.styleable.WheelView_unitHeight, unitHeight);
        //按理说应该是奇数，但是此次不做判断，使用者有义务设置正确
        itemNumber = attribute.getInt(com.pl.whellview.R.styleable.WheelView_itemNumber, itemNumber);

        normalFont = attribute.getDimension(com.pl.whellview.R.styleable.WheelView_normalTextSize, normalFont);
        selectedFont = attribute.getDimension(com.pl.whellview.R.styleable.WheelView_selectedTextSize, selectedFont);
        normalColor = attribute.getColor(com.pl.whellview.R.styleable.WheelView_normalTextColor, normalColor);
        selectedColor = attribute.getColor(com.pl.whellview.R.styleable.WheelView_selectedTextColor, selectedColor);

        lineColor = attribute.getColor(com.pl.whellview.R.styleable.WheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(com.pl.whellview.R.styleable.WheelView_lineHeight, lineHeight);

        noEmpty = attribute.getBoolean(com.pl.whellview.R.styleable.WheelView_noEmpty, true);
        isEnable = attribute.getBoolean(com.pl.whellview.R.styleable.WheelView_isEnable, true);
        isCyclic =attribute.getBoolean(com.pl.whellview.R.styleable.WheelView_isCyclic,true);
