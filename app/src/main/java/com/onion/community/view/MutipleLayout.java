...
import com.onion.community.util.Utils;
 ...
 * on date 2016-03-12
 */
public class MutipleLayout extends FrameLayout {
    ...
    public MutipleLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MutipleLayout);
        isFirstVisible = a.getBoolean(R.styleable.MutipleLayout_isFirstVisible, false);
        a.recycle();
    }

    public MutipleLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext = context;
    }

    public MutipleLayout(Context context) {
        super(context);
        this.mContext = context;
    }
     ...
     * @return
     */
    public MutipleLayout setEmptyText(String text) {
     ...
     * @return
     */
    public MutipleLayout setErrorText(String text) {
     ...
     * @return
     */
    public MutipleLayout setNoNetworkText(String text) {
     ...
     * @return
     */
    public MutipleLayout setEmptyImage(@DrawableRes int id) {
     ...
     * @return
     */
    public MutipleLayout setErrorImage(@DrawableRes int id) {
     ...
     * @return
     */
    public MutipleLayout setNoNetworkImage(@DrawableRes int id) {
     ...
     * @return
     */
    public MutipleLayout setEmptyTextSize(int sp) {
     ...
     * @return
     */
    public MutipleLayout setErrorTextSize(int sp) {
     ...
     * @return
     */
    public MutipleLayout setNoNetworkTextSize(int sp) {
     ...
     * @return
     */
    public MutipleLayout setEmptyImageVisible(boolean bool) {
     ...
     * @return
     */
    public MutipleLayout setErrorImageVisible(boolean bool) {
     ...
     * @return
     */
    public MutipleLayout setNoNetworkImageVisible(boolean bool) {
     ...
     * @return
     */
    public MutipleLayout setReloadButtonText(@NonNull String text) {
     ...
     * @return
     */
    public MutipleLayout setReloadButtonTextSize(int sp) {
     ...
     * @return
     */
    public MutipleLayout setReloadButtonTextColor(@ColorRes int id) {
     ...
     * @return
     */
    public MutipleLayout setReloadButtonBackgroundResource(@DrawableRes int id) {
     ...
     * @return
     */
    public MutipleLayout setOnReloadListener(OnReloadListener listener) {

        this.listener = listener;
        return this;
    }

    public MutipleLayout setEmptyBgColor(int color){
        emptyPage.setBackgroundColor(color);
        return this;
    }

    public MutipleLayout setErrorBgColor(int color){
     ...
     * @return
     */
    public MutipleLayout setLoadingPage(View view) {
     ...
     * @return
     */
    public MutipleLayout setLoadingPage(@LayoutRes int id) {
     ...
     * @return
     */
    public MutipleLayout setDefineBackgroundColor(@ColorRes int color) {
