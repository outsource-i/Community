...
/**
 * Created by OnionMac on 2018/8/13.
 */
...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) AppCenter.getInstance().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return AppCenter.getInstance().getResources().getDisplayMetrics().widthPixels;
        }
    ...
    public static int getScreenHeight() {
        WindowManager wm = (WindowManager) AppCenter.getInstance().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return AppCenter.getInstance().getResources().getDisplayMetrics().heightPixels;
        }
        Point point = new Point();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            wm.getDefaultDisplay().getRealSize(point);
    ...
    public static float getScreenDensity() {
        return AppCenter.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static int getScreenDensityDpi() {
        return AppCenter.getInstance().getResources().getDisplayMetrics().densityDpi;
    }
    ...
    public static boolean isLandscape() {
        return AppCenter.getInstance().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) AppCenter.getInstance().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                AppCenter.getInstance().getContentResolver(),
    ...
    public static boolean isTablet() {
        return (AppCenter.getInstance().getResources().getConfiguration().screenLayout
    ...
    private static void adaptScreen(final Activity activity,
        ...
        final DisplayMetrics appDm = AppCenter.getInstance().getResources().getDisplayMetrics();
